...
def getData():
    ...
    forecastHumidity = one_call.forecast_hourly[HOURS_LATER].humidity
    ...
    print("MeteoForecast -", HOURS_LATER, "h later => ",
          ...
          ", Rain:", forecastRain)
    data_to_save = [date_formatted, HOURS_LATER, forecastTemperature, forecastHumidity, forecastRain]
